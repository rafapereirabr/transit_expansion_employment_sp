plot_trial <- dates |>
	...
	labs(
		...
		fill = "Linha",
		caption = paste0(
			"Datas coletadas de diversas fontes.",
...
ggsave(
	filename = "figures/plot_trial.png",
	plot = plot_trial, #width = 8, height = 8,
	dpi = 600,
	bg = "white"
)
...
ggsave(
	filename = "figures/plot_elections.png",
	plot = plot_elections, #width = 8, height = 6,
	dpi = 600,
	bg = "white"
)
